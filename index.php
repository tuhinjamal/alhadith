...
//echo '<pre>';
 //print_r($_POST);
    ...
    function view_prayer_time(){
 		...
 		require'db_con.php';
 		$sql= 'SELECT * FROM tbl_hadith WHERE id = 3';
...
<div class="frame2">
		<table>
			<tr>
				...
				<td><a href="hadith_2.php" class="link2"> Hadith:5</a></td>
...
<div class="lgn">
		<table>
			<tr>
				...
				<td><a href="lgs.php" class="pnl" target="_blank"> admin</a></td>
				<td><a href="reg.php" class="pnl" target="_blank">;ogin & register</a></td>
